...
def get_friends():
	...
	return mysql.query_db("SELECT first_name, last_name, occupation FROM friends;")
...
# VALUES ("Zaphod", "Beeblebrox", "President of the Galaxy", CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
