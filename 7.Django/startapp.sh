...
touch "./apps/$1/templates/$1/index_base.html"
touch "./apps/$1/templates/$1/head.html"
...
' > "./apps/$1/templates/$1/index_base.html"
...
<script src="{% static "'"$1"'/js/script.js" %}"></script>' > "./apps/$1/templates/$1/head.html"

echo '{% extends "'"$1"'/index_base.html" %}
